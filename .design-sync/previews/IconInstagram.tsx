...
export const OnDark = () => (
  <div style={{ display: 'flex', gap: 24, padding: '24px 32px', background: '#2C1810', borderRadius: 16, alignItems: 'center' }}>
    <IconInstagram size={24} style={{ color: '#FAF6F1' }} />
    <IconInstagram size={18} style={{ color: '#C9A84C' }} />
  </div>
)
