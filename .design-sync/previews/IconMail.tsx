...
export const WithLabel = () => (
  <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '10px 16px', background: '#FAF6F1', borderRadius: 8 }}>
    <IconMail size={18} style={{ color: '#2C1810', flexShrink: 0 }} />
    <span style={{ fontFamily: 'system-ui', fontSize: 14, color: '#2C1810' }}>yum@imaginarycakes.com</span>
  </div>
)
